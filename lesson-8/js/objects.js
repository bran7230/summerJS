...
let person = {
    ...
    return`Hello, my name is ${this.name.firstName} ${this.name.lastName} and I am ${this.age} years old, my gender is ${this.gender}, my interests are: ${this.interests.join(', ')}.`;
 }
...
let key = "hairColor";
let value = "Black";
person[key] = value; // Dynamically adding a new property to the person object
...
person.goodbye = function(){
    alert(`Goodbye ${this.name.firstName}!`);
}
